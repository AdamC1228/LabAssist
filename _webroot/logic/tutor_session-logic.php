...
/*
 * Generate the clockin/clockout form.
 */
...
/*
 * Attempt to do a clockin/clockout.
 */
...
/*
 * Generate the department select box.
 */
...
/*
 * Check if we should do a clock-in.
 */
function isClockin()
{
